...
const passkeybody = (name, passkey)=>{
          return    `
          <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                          ...
                          <div style="background-color: #48a9e6;height: 100%;width: 100% !important;">
                              ...
                              <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                  ...
                                  <tr>
                                      ...
                                      <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong>OASIS Dataset!</strong></span></p>
                                      </div>
                          ...
                          <div style="height: 100%;width: 100% !important;">
                              ...
                              <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                  ...
                                  <tr>
                                      ...
                                      <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                          <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><span style="font-size: 22px; line-height: 35.2px;">Hi <strong>${name}</strong></span>, </span>
                                          </p>
                                          <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 20px; line-height: 32px;">We'd like to confirm that <strong><span style="color: #2dc26b; line-height: 32px;">your account was created successfully.</span>
                                          </strong> To download the dataset please use the following key as your passkey.</span>
                                          </p>
                                      </div>
                              ...
                              <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                  ...
                                  <tr>
                                      ...
                                      <div align="center">
                                          <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:44px; v-text-anchor:middle; width:132px;" arcsize="9%"  stroke="f" fillcolor="#2dc26b"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
                                          <a href="" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #2dc26b; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                          <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="line-height: 16.8px;"><strong><span style="line-height: 16.8px;">${passkey}</span></strong>
                                          </span>
                                          </span>
                                          </a>
                                          <!--[if mso]></center></v:roundrect><![endif]-->
                              ...
                              <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                  ...
                                  <tr>
                                      ...
                                      <div style="line-height: 170%; text-align: center; word-wrap: break-word;">
                                          <p style="line-height: 170%; font-size: 14px;"><span style="font-size: 20px; line-height: 34px;">Thanks,</span></p>
                                          <p style="line-height: 170%; font-size: 14px;"><span style="font-size: 20px; line-height: 34px;">The OASIS research team.</span></p>
                                      </div>
...
function sendPasskey(recieversEmail, name, passkey){
    ...
    return new Promise((resolve, reject)=>{
        ...
        const mail_config = {
            from: `OASIS Tech Team <${process.env.SENDERS_EMAIL}>`,
            to: recieversEmail,
            subject: 'OASISdataset Account Registrations',
            matext:'Your OASISdataset account is ready to use. Use your credentials to download the dataset.',
            html: passkeybody(name, passkey)
        }
...
module.exports = { sendEmail, sendPasskey };